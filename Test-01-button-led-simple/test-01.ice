  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "65f76018-81bb-4834-b502-553d33a2e8d9",
          "type": "basic.output",
          "data": {
            "name": "Serial",
            "pins": [
        ...
        {
          "id": "46e0f997-bbcd-485a-8e04-6c3fc6363fb2",
        ...
        {
          "id": "309f2980-45fc-4f20-8264-cf81064327d8",
        ...
        {
          "id": "1174c6c2-3150-4d31-8aa4-3054d0ffe9d2",
          "type": "basic.inputLabel",
          "data": {
            "name": "rdy",
            "range": "[9:0]",
        ...
        {
          "id": "04e46926-faa1-482a-bb12-0a3772ad0324",
          "type": "basic.outputLabel",
          "data": {
        ...
        {
          "id": "39b6b0fe-b968-40c8-be94-ae27e89e5b90",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "pins": [
        ...
        {
          "id": "27e35ebe-bc2e-4a35-9a88-3696841a61a9",
          "type": "basic.inputLabel",
          "data": {
            "blockColor": "darkgreen",
            "name": "changed",
        ...
        {
          "id": "b5820b8e-0893-4e41-a9f5-9682e83d0b5d",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "navy",
            "name": "bstate",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# TEST-1: Control por puerto serie  \n\nEl estado del LED0 se controla con los caracteres '0' y'1' recibidos por  \nel puerto serie  \n\nCada vez que cambia el estado del pulsador SW1, se envía su nuevo estado (0/1)  \npor el puerto serie (Carateres '0' ó '1')\n\n",
            "readonly": true
          },
          "position": {
            "x": -112,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "El bit que llega (0/1) se  \nalmacena en el biestable",
            "readonly": true
          },
          "position": {
            "x": 840,
        ...
        {
          "id": "3053aacb-7a90-4051-a4f9-9932158eeecf",
        ...
        {
          "id": "1e48e884-c12d-4659-b13f-eb41c06021e5",
        ...
        {
          "id": "9b24b84b-8d33-46d3-8721-b402bbc16a2d",
          "type": "basic.info",
          "data": {
            "info": "Estado del pulsador:  \n0: No apretado  \n1: Pulsador",
            "readonly": true
          },
          "position": {
            "x": 320,
        ...
        {
          "id": "8beee0d2-e631-4e1e-b7d9-3c398a8aa609",
          "type": "basic.info",
          "data": {
            "info": "El estado del pulsador  \nha cambiad",
            "readonly": true
          },
          "position": {
            "x": 368,
        ...
        {
          "id": "99847afd-921c-4ae4-aff1-526a4afe82e4",
          "type": "basic.info",
          "data": {
            "info": "Transmit the  \nbutton state",
            "readonly": true
        ...
        {
          "id": "a8e30f68-58ff-4975-80e6-97072b09ba89",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "bbf38ae8-6416-4b7f-a8e9-5be7d75ce32e",
        ...
        {
          "id": "47f48d49-d5d8-47f6-acf9-98a6d47a0e95",
          "type": "basic.info",
          "data": {
            "info": "### Recepción de caracteres",
            "readonly": true
          },
          "position": {
            "x": 392,
        ...
        {
          "id": "2caf790a-8a57-400e-a762-1e1ac6421a3e",
          "type": "basic.info",
          "data": {
            "info": "Sólo se procesan los caracteres  \n'0' y '1'. El resto se ignoran",
            "readonly": true
          },
          "position": {
            "x": 696,
        ...
        {
          "id": "2779b4af-764f-44a2-9c6d-9880d139f50b",
          "type": "basic.info",
          "data": {
            "info": "Estado del LED",
            "readonly": true
        ...
        {
          "id": "f21fa375-9254-4c46-a607-caeec8db62c3",
          "type": "basic.info",
          "data": {
            "info": "### Envío de datos",
            "readonly": true
        ...
        {
          "id": "2e87c426-9cdb-41b2-838a-fab9f268dc10",
          "type": "basic.info",
          "data": {
            "info": "Transmitir el estado  \ndel pulsador (0/1)",
            "readonly": true
          },
          "position": {
            "x": 824,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "3053aacb-7a90-4051-a4f9-9932158eeecf",
            "port": "f2043f09-b391-40ea-9d1d-721438b68ef1"
          },
          "target": {
            "block": "65f76018-81bb-4834-b502-553d33a2e8d9",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "1174c6c2-3150-4d31-8aa4-3054d0ffe9d2",
            "port": "inlabel"
          },
          "size": 10
        },
        {
          "source": {
            "block": "1e48e884-c12d-4659-b13f-eb41c06021e5",
            "port": "4e8afe74-8f38-4873-97ee-f7585d99a4aa"
          },
          "target": {
            "block": "309f2980-45fc-4f20-8264-cf81064327d8",
            "port": "inlabel"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "27e35ebe-bc2e-4a35-9a88-3696841a61a9",
            "port": "inlabel"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "39b6b0fe-b968-40c8-be94-ae27e89e5b90",
            "port": "out"
          },
          "target": {
            "block": "1e48e884-c12d-4659-b13f-eb41c06021e5",
        ...
        {
          "source": {
            "block": "b5820b8e-0893-4e41-a9f5-9682e83d0b5d",
            "port": "outlabel"
          },
          "target": {
            "block": "bbf38ae8-6416-4b7f-a8e9-5be7d75ce32e",
        ...
        {
          "source": {
            "block": "46e0f997-bbcd-485a-8e04-6c3fc6363fb2",
            "port": "outlabel"
          },
          "target": {
            "block": "bbf38ae8-6416-4b7f-a8e9-5be7d75ce32e",
        ...
        {
          "source": {
            "block": "04e46926-faa1-482a-bb12-0a3772ad0324",
            "port": "outlabel"
          },
          "target": {
            "block": "bbf38ae8-6416-4b7f-a8e9-5be7d75ce32e",
